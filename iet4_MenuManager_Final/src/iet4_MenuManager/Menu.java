...
public class Menu 
{
	...
	public String description()
	{
		...
		//combining together
		desc ="Entree: "+ entree.getName() +". " +entreeStr + ". Calories: "+ entree.getCalories()+". Price: $" + entree.getPrice()+ "\nSide: " + side.getName() +". "+ sideStr + ". Calories: "+side.getCalories()+". Price: $"+ side.getPrice()+"\nSalad: " + salad.getName() +". "+ saladStr + ". Calories: " + salad.getCalories()+". Price: $" +salad.getPrice() 
				+ "\nDessert: " + dessert.getName() +". "+ dessertStr + ". Calories: "+ dessert.getCalories() +". Price: $"+ dessert.getPrice();
